...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          list(url: 'assets/one.jfif',name: "Monika Goldsmith",tym: "1.57pm",desc: "Hallo",msg: "2",isRead: true),
          Divider(height: 0.2,),
          list(url: 'assets/two.jfif',name: "Kate",tym: "2.21pm",desc: "hallo apa kabar",msg: "",isRead: false),
          Divider(height: 0.2,),
          list(url: 'assets/three.jfif',name: "Agus",tym: "1.18pm",desc: "love u",msg: "2",isRead: true),
          Divider(height: 0.2,),
          list(url: 'assets/six.jfif',name: "Dani",tym: "2.31pm",desc: "whr r u baby?",msg: "2",isRead: true),
          Divider(height: 0.2,),
          list(url: 'assets/7.jfif',name: "Budi",tym: "3.25pm",desc: "missing u",msg: "",isRead: false),
          Divider(height: 0.2,),
          list(url: 'assets/8.jfif',name: "Badu",tym: "2.41pm",desc: "hai my love <3",msg: "2",isRead: true),
          Divider(height: 0.2,),
        ],
      ),
    );
